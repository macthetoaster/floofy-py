actions = {
    "boop": {
        "self": "boops themselves!",
        "emoji": "<:meow_boop:960689660001124352>",
        "with_receivers": [
            "sneakily walks towards {receivers} and boops them on the snoot!",
            "boops {receivers} softly",
            "runs towards {receivers} and boops them!",
    ...
    "pat": {
        ...
        "with_receivers": [
            ...
            "softly pets {receivers}",
            "approaches {receivers} and gives them some pets!",
    ...
    "hug": {
        ...
        "with_receivers": [
            "hugs {receivers}!",
            "jumps on {receivers} and hugs them!",
    ...
    "nuzzle": {
        ...
        "with_receivers": [
            "gets up close to {receivers} and nuzzles them!",
            "nuzzles {receivers}",
    ...
    "food": {
        ...
        "with_receivers": [
            "gives {receivers} a perfectly cooked :hamburger:! Yum!",
            "gives {receivers} a delicious bowl of :salad:! Nom~",
            "gives {receivers} a :burrito:! So good!",
            "gives {receivers} a steaming hot bowl of :ramen:! Tasty!",
            "gives {receivers} a big :sandwich:! Mmmmmm~",
    ...
    "slap": {
        ...
        "with_receivers": [
            "slaps {receivers}!",
            "smacks {receivers} across the face!",
            "slapped {receivers}! Oh no!",
    ...
    "bite": {
        ...
        "with_receivers": [
            "slowly gets closer to {receivers} and bites them!",
            "softly nibbles {receivers}!",
            "bites {receivers}",
            "sneaks towards {receivers} and chomps them! Rawr!",
            "munches on {receivers}!",
    ...
    "snuggle": {
        ...
        "with_receivers": [
            "taps {receivers} on the shoulder and snuggles them!",
            "snuggles {receivers}! So comfy~",
...
actions["cuddles"] = actions["cuddle"]
actions["snuggles"] = actions["snuggle"]
actions["hugs"] = actions["hug"]
actions["bitchslap"] = actions["slap"]
